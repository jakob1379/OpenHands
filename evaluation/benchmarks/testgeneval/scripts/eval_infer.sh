...
COMMAND="uvx poetry run python evaluation/benchmarks/testgeneval/eval_infer.py \
...
# uvx poetry run python evaluation/benchmarks/testgeneval/scripts/eval/update_output_with_eval.py $INPUT_FILE
