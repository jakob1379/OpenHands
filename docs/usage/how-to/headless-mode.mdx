...
```bash
uvx poetry run python -m openhands.core.main -t "write a bash script that prints hi"
```
...
uvx poetry run python -m openhands.core.main \
...
uvx poetry run python -m openhands.core.main -t "fix any linting issues"
...
uvx poetry run python -m openhands.core.main -f task.txt --selected-repo "owner/repo"
```
...
Run `uvx poetry run python -m openhands.core.main --help` for all options.
